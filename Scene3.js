class Scene3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.douya = this.physics.add.sprite(615, 738, "angel_idle");
        ...
        this.bush15IsDestroyed = false;
        this.bush16IsDestroyed = false;
        ...
        this.bush15 = this.physics.add.sprite(615, 369, "bush_object");
        this.bush15.setOrigin(0);
        this.bush15.body.immovable = true;
        this.bush15.setInteractive();

        this.bush16 = this.physics.add.sprite(738, 369, "bush_object");
        this.bush16.setOrigin(0);
        this.bush16.body.immovable = true;
        this.bush16.setInteractive();
        ...
        this.physics.add.collider(this.douya, this.rock2);
        this.physics.add.collider(this.douya, this.rock3);
        this.physics.add.collider(this.douya, this.rock4);
        ...
        this.physics.add.collider(this.douya, this.bush5);
        this.physics.add.collider(this.douya, this.bush6);
        this.physics.add.collider(this.douya, this.bush7);
        this.physics.add.collider(this.douya, this.bush8);
        this.physics.add.collider(this.douya, this.bush9);
        this.physics.add.collider(this.douya, this.bush10);
        this.physics.add.collider(this.douya, this.bush11);
        this.physics.add.collider(this.douya, this.bush12);
        this.physics.add.collider(this.douya, this.bush13);
        this.physics.add.collider(this.douya, this.bush14);
        this.physics.add.collider(this.douya, this.bush15);
        this.physics.add.collider(this.douya, this.bush16);
    ...
    action(pointer, gameObject) {
        if (gameObject == this.target) {
            if (this.target.x == this.rock.x && this.target.y == this.rock.y) { // ROCKS
                if (this.rockGoUp) {
            ...
            } else if (this.target.x == this.bush15.x && this.target.y == this.bush15.y) {
                this.bush15.play("cut_anim");
                this.time.delayedCall(1000, function () {
                    this.bush15.destroy();
                    this.bush15IsDestroyed = true;
                    this.bushCount++;
                }, [], this);
            } else if (this.target.x == this.bush16.x && this.target.y == this.bush16.y) {
                this.bush16.play("cut_anim");
                this.time.delayedCall(1000, function () {
                    this.bush16.destroy();
                    this.bush16IsDestroyed = true;
                    this.bushCount++;
                }, [], this);
            }
        }
    ...
    moveRockManager() {
        ...
        if (!this.bush15IsDestroyed) {
            if (this.rock.x + 123 == this.bush15.x && this.rock.y == this.bush15.y) {
                this.rockGoRight = false;
            } else if (this.rock.x - 123 == this.bush15.x && this.rock.y == this.bush15.y) {
                this.rockGoLeft = false;
            } else if (this.rock.x == this.bush15.x && this.rock.y + 123 == this.bush15.y) {
                this.rockGoDown = false;
            } else if (this.rock.x == this.bush15.x && this.rock.y - 123 == this.bush15.y) {
                this.rockGoUp = false;
            }
        }
        if (!this.bush16IsDestroyed) {
            if (this.rock.x + 123 == this.bush16.x && this.rock.y == this.bush16.y) {
                this.rockGoRight = false;
            } else if (this.rock.x - 123 == this.bush16.x && this.rock.y == this.bush16.y) {
                this.rockGoLeft = false;
            } else if (this.rock.x == this.bush16.x && this.rock.y + 123 == this.bush16.y) {
                this.rockGoDown = false;
            } else if (this.rock.x == this.bush16.x && this.rock.y - 123 == this.bush16.y) {
                this.rockGoUp = false;
            }
        ...
        if (!this.bush15IsDestroyed) {
            if (this.rock2.x + 123 == this.bush15.x && this.rock2.y == this.bush15.y) {
                this.rock2GoRight = false;
            } else if (this.rock2.x - 123 == this.bush15.x && this.rock2.y == this.bush15.y) {
                this.rock2GoLeft = false;
            } else if (this.rock2.x == this.bush15.x && this.rock2.y + 123 == this.bush15.y) {
                this.rock2GoDown = false;
            } else if (this.rock2.x == this.bush15.x && this.rock2.y - 123 == this.bush15.y) {
                this.rock2GoUp = false;
            }
        ...
        if (!this.bush16IsDestroyed) {
            if (this.rock2.x + 123 == this.bush16.x && this.rock2.y == this.bush16.y) {
                this.rock2GoRight = false;
            } else if (this.rock2.x - 123 == this.bush16.x && this.rock2.y == this.bush16.y) {
                this.rock2GoLeft = false;
            } else if (this.rock2.x == this.bush16.x && this.rock2.y + 123 == this.bush16.y) {
                this.rock2GoDown = false;
            } else if (this.rock2.x == this.bush16.x && this.rock2.y - 123 == this.bush16.y) {
                this.rock2GoUp = false;
            }
        ...
        if (!this.bush15IsDestroyed) {
            if (this.rock3.x + 123 == this.bush15.x && this.rock3.y == this.bush15.y) {
                this.rock3GoRight = false;
            } else if (this.rock3.x - 123 == this.bush15.x && this.rock3.y == this.bush15.y) {
                this.rock3GoLeft = false;
            } else if (this.rock3.x == this.bush15.x && this.rock3.y + 123 == this.bush15.y) {
                this.rock3GoDown = false;
            } else if (this.rock3.x == this.bush15.x && this.rock3.y - 123 == this.bush15.y) {
                this.rock3GoUp = false;
            }
        ...
        if (!this.bush16IsDestroyed) {
            if (this.rock3.x + 123 == this.bush16.x && this.rock3.y == this.bush16.y) {
                this.rock3GoRight = false;
            } else if (this.rock3.x - 123 == this.bush16.x && this.rock3.y == this.bush16.y) {
                this.rock3GoLeft = false;
            } else if (this.rock3.x == this.bush16.x && this.rock3.y + 123 == this.bush16.y) {
                this.rock3GoDown = false;
            } else if (this.rock3.x == this.bush16.x && this.rock3.y - 123 == this.bush16.y) {
                this.rock3GoUp = false;
            }
    ...
    rockPosManager() {
        if ((this.rock.x == 369 && this.rock.y == 492) || (this.rock2.x == 369 && this.rock2.y == 492) ||
            this.rock3.x == 369 && this.rock3.y == 492) {
